...
module ActiveMerchant # :nodoc:
  module Billing # :nodoc:
    class MaxipagoGateway < Gateway
      ...
      def commit_transaction(action, &block)
        request = build_xml_transaction_request(action, &block)
      ...
      def commit_api(action, &block)
        request = build_xml_api_request(action, &block)
